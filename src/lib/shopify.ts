...
const SHOPIFY_STORE_PERMANENT_DOMAIN = 'phenix-9077.myshopify.com';
const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
const SHOPIFY_STOREFRONT_TOKEN = 'da354d4a915b831affd79ed1e4c00eba';
...
export async function fetchProducts(
  ...
  const data = await storefrontApiRequest(STOREFRONT_QUERY, { first, query, sortKey, reverse });
